...
RSpec::OpenAPI.path = File.expand_path("../apps/rails/doc/minitest_openapi.#{ENV.fetch('OPENAPI_OUTPUT', nil)}",
                                       __dir__,)
...
RSpec::OpenAPI.post_process_hook = ->(_path, _records, spec) { spec['x-custom-field'] = 'custom_value' }
...
module RailsIntegrationTests
  class TablesIndexTest < ActionDispatch::IntegrationTest
    ...
    def self.runnable_methods
      [
        'test_with_flat_query_parameters',
        'test_with_deep_query_parameters',
        'test_with_different_deep_query_parameters',
        'test_has_a_request_spec_which_does_not_make_any_request',
        'test_does_not_return_tables_if_unauthorized',
      ]
    end
  ...
  class TablesShowTest < ActionDispatch::IntegrationTest
    ...
    def self.runnable_methods
      [
        'test_returns_a_table',
        'test_does_not_return_a_table_if_unauthorized',
